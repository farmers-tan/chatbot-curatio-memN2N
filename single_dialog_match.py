...
from data_utils import load_dialog_task, vectorize_data_match, load_candidates, vectorize_candidates, vectorize_candidates_sparse, tokenize, parse_kb, load_glove, process_word, create_embedding
from sklearn import metrics
from memn2n import MemN2NDialog
from memn2n import MemN2NDialogHybridMatch
...
tf.flags.DEFINE_string("kb_file", "data/1-1-QA-without-context/dialog-babi-kb-all.txt", "KB file path")
...
class chatBot(object):
    def __init__(self, data_dir, model_dir, task_id, isInteractive=True, OOV=False, memory_size=50, random_state=None, batch_size=32, learning_rate=0.001, epsilon=1e-8, max_grad_norm=40.0, evaluation_interval=10, hops=3, epochs=200, embedding_size=100):
        ...
        self.model = MemN2NDialogHybridMatch(self.batch_size, self.vocab_size, self.max_sentence_size, self.memory_size, self.embedding_size, answer_n_hot, match=FLAGS.match, session=self.sess,
